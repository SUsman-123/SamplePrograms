...
# This Class is used to search for a file in our local drives by using multi-threading
# This class then calls UploadFilesToDB to store file search results in sql db
class FindFileLocation:

    # This Method find_file is used to search for a file in our local drive
    ...
    # This Method is used to get all the available drives in our local system
    ...
    # This Method is used to call method upload_file_results_todb which is in class UploadFilesToDB
