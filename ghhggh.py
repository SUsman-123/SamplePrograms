...
server = 'HCL-02-NEW-06\SQLEXPRESS\EXPRESS'
...
class UploadFilesToDB:
    ...
    def search_in_db_for_file(self, fileName):
        # select query
        query = ''' select * from FileSearchResult_table where NameOfFile = '{0}' '''
    ...
    def update_file_searchcount(self, fileName):
        try:
            ...
            for fileInfo in values:
                ...
                fileinfoQuery = '''
                        Update FileSearchResult_table SET SearchCount = {0} WHERE NameOfFile = '{1}'
                        '''
